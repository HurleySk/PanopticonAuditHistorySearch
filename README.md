...
> **0.1.0-alpha.1.** Feature-complete against the v1 scope and verified for build, packaging, plugin load and cache/search behaviour, but not yet exercised end to end against a live Dataverse org. Expect rough edges, and treat the cache format as unstable.
